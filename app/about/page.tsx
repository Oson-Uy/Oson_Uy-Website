...
export default async function About() {
    ...
    const stats = [
        { label: t("stats.developers"), value: "24+", icon: Users },
        { label: t("stats.projects"), value: "120+", icon: Globe },
        { label: t("stats.transactions"), value: "1,500+", icon: BarChart3 },
        { label: t("stats.verified"), value: "100%", icon: Shield },
    ];
            ...
            <div className="w-full px-4 md:px-8 max-w-7xl mx-auto space-y-32">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    <div className="space-y-10">
                        <h1 className="text-7xl font-black text-[#1E3A8A] tracking-tighter leading-none">
                            {t("title1")} <span className="text-[#F97316]">{t("titleAccent")}</span>
                        </h1>
                ...
                <div className="bg-[#1E3A8A] p-16 md:p-28 rounded-[4rem] text-center space-y-10 relative overflow-hidden shadow-2xl shadow-blue-900/20">
                    ...
                    <div className="relative z-10 space-y-4">
                        <div className="text-[#F97316] text-xs font-black uppercase tracking-[0.4em] mb-4">{t("commitment")}</div>
                        <h2 className="text-5xl md:text-7xl font-black text-white tracking-tight leading-tight">{t("secure")}</h2>
                    </div>
